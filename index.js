...
7. 防呆機制：如果這是一篇購物網站、系統登入頁、檔案目錄或純粹的廣告頁，請不要進行摘要，並直接回覆：「這似乎不是一篇新聞文章，請提供有效的新聞連結喔！」
8. 雜訊忽略：網頁擷取的文本可能在開頭或結尾包含大量導覽列、社群分享按鈕、版權宣告或廣告連結。請忽略這些雜訊，主動往下尋找正文。只要文本中包含「新聞標題」與「報導內文」，就視為有效新聞並進行摘要，絕對不可誤判為檔案目錄。
